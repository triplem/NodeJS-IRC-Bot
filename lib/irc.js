...
Server.prototype.loadPlugin = function(name) {
    ...
    try {
        ...
        this.logger.error('Cannot load Plugin:', err.message);
...
Server.prototype.getProperty = function(pluginName, propertyName) {
    return this.pluginConfigs[pluginName][propertyName];
};
