...
Plugin.prototype.trigGezien = function(msg) {
	...
	if (typeof params[0] == 'undefined') {
		chan.send('\002Voorbeeld:\002 .gezien <naam>');
	} else {
		var seek = params[0].toLowerCase();

		if (typeof this.gezien[seek] == 'undefined') {
			chan.send('Ik heb \002' + params[ 0] + '\002 nog nooit gezien!');
		} else {
			...
			chan.send('Ik heb \002' + params[ 0] + '\002 voor het laatst gezien op: \002' + lastDate + '\002 om \002' + lastTime + '\002');
		}
	}
};